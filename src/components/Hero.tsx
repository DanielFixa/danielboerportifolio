...
export function Hero() {
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
            <InteractiveGridPattern className="opacity-30" />

            <div className="container mx-auto px-6 relative z-10 text-center pointer-events-none">
                <BlurFade delay={0.25} inView>
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight max-w-5xl mx-auto leading-tight mb-8 pointer-events-auto">
                        Transformo seu negócio local em uma <AuroraText>vitrine digital de alto nível</AuroraText>.
                    </h1>
                </BlurFade>

                <BlurFade delay={0.5} inView>
                    <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto mb-12 pointer-events-auto">
